                        ...
                        {item.values.map((child,k) => (
                            child.total>0?
                                <div className="list-group-item d-flex gap-2 rdList" key={k}>
                                    ...
                                    <label for={`searchFilters_${item.name}_${child.name}`} className="radio-custom-label">{child.name} <small className="text-body-secondary ml-auto">({child.total})</small></label>
                                </div>
                            :''
                        ))}
                    </div>
